                ...
                <div class="box-body">
                    <form method="post" id="saveForm">
                        <div class="form-group">
                            <label>下发日期</label>
                            <input type="text" class="form-control" value="${taday}" disabled>
                        </div>
                        <div class="form-group">
                            <label>下发网点</label>
                            <select name="ticketStoreAccountid" class="form-control">
                                <c:forEach items="${ticketStroeList}" var="store">
                                    <option value="${store.id}">${store.stroeName}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
